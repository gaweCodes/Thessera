...
var connectionString = Environment.GetEnvironmentVariable("THESSERA_EXAMPLE_POSTGRES")
    ?? EventSourcedWithMessagingApplication.DefaultConnectionString;
var rabbitMqUri = Environment.GetEnvironmentVariable("THESSERA_EXAMPLE_RABBITMQ")
    ?? EventSourcedWithMessagingApplication.DefaultRabbitMqUri;
    ...
    switch (selection)
    {
        ...
        default:
            Console.WriteLine(JsonSerializer.Serialize(
                ...
                EventSourcedWithMessagingJson.Options));
            break;
    }
}
...
static void Print<TResult>(Result<TResult> result)
    ...
    Console.WriteLine(JsonSerializer.Serialize(ResultEnvelope.From(result), EventSourcedWithMessagingJson.Options));

static void PrintEnvelope(ResultEnvelope envelope) =>
    Console.WriteLine(JsonSerializer.Serialize(envelope, EventSourcedWithMessagingJson.Options));
