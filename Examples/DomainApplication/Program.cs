...
static void Print<TResult>(Result<TResult> result)
    ...
    Console.WriteLine(JsonSerializer.Serialize(ResultEnvelope.From(result), DomainApplicationJson.Options));

static void PrintEnvelope(ResultEnvelope envelope) =>
    Console.WriteLine(JsonSerializer.Serialize(envelope, DomainApplicationJson.Options));
